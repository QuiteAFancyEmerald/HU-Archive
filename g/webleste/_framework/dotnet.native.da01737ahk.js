...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 37617664;
...
var ASM_CONSTS = {
 ...
 1345890: () => Module["SDL3"].audioContext.sampleRate,
 1345941: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1351495: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1351554: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 1362749: () => window.innerWidth,
 1362779: () => window.innerHeight,
 1362810: $0 => {
...
DOTNET.setup({
 ...
 gitHash: "e36e4d1a8f8dfb08d7e3a6041459c9791d732c01"
});
